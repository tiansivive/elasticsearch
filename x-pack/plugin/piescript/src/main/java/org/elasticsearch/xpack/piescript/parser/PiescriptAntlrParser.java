...
public class PiescriptAntlrParser extends Parser {
    ...
    public static final int LET = 1, IN = 2, FN = 3, IF = 4, THEN = 5, ELSE = 6, TRUE = 7, FALSE = 8, NULL = 9, MATCH = 10, LOOP = 11,
        REPEAT = 12, QUERY = 13, SPAWN_BANG = 14, SPAWN = 15, SEND = 16, WHEN = 17, USE = 18, AS = 19, PAR = 20, DO = 21, UNDERSCORE = 22,
        PIPE_OP = 23, OR_OP = 24, AND_OP = 25, ARROW = 26, EQ = 27, NEQ = 28, LTE = 29, GTE = 30, LT = 31, GT = 32, PLUS = 33, MINUS = 34,
        ASTERISK = 35, SLASH = 36, PERCENT = 37, BANG = 38, DOT = 39, COMMA = 40, COLON = 41, SEMICOLON = 42, ASSIGN = 43, AMP = 44, BAR =
            45, LPAREN = 46, RPAREN = 47, LBRACE = 48, RBRACE = 49, LBRACKET = 50, RBRACKET = 51, INTEGER_LITERAL = 52, DECIMAL_LITERAL =
                53, QUOTED_STRING = 54, UPPER_IDENT = 55, LOWER_IDENT = 56, LINE_COMMENT = 57, MULTILINE_COMMENT = 58, WS = 59;
    public static final int RULE_ident = 0, RULE_program = 1, RULE_topBinding = 2, RULE_expr = 3, RULE_alternative = 4, RULE_pattern = 5,
        RULE_recordPatField = 6, RULE_whenBinding = 7, RULE_pipeExpr = 8, RULE_orExpr = 9, RULE_andExpr = 10, RULE_eqExpr = 11,
        RULE_cmpExpr = 12, RULE_addExpr = 13, RULE_mulExpr = 14, RULE_unaryExpr = 15, RULE_appExpr = 16, RULE_literal = 17, RULE_primary =
            18, RULE_recordField = 19, RULE_recordUpdate = 20, RULE_block = 21, RULE_blockStmt = 22, RULE_param = 23, RULE_type = 24,
        RULE_typeApp = 25, RULE_typeAtom = 26, RULE_rowType = 27, RULE_rowField = 28;
    ...
    public static class TopBindingContext extends ParserRuleContext {
        ...
        public TopBindingContext() {}

        public void copyFrom(TopBindingContext ctx) {
            super.copyFrom(ctx);
        }
    }

    @SuppressWarnings("CheckReturnValue")
    public static class TopLetContext extends TopBindingContext {
        ...
        public TopLetContext(TopBindingContext ctx) {
            copyFrom(ctx);
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof PiescriptAntlrParserListener) ((PiescriptAntlrParserListener) listener).enterTopLet(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof PiescriptAntlrParserListener) ((PiescriptAntlrParserListener) listener).exitTopLet(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof PiescriptAntlrParserVisitor) return ((PiescriptAntlrParserVisitor<? extends T>) visitor).visitTopLet(
                this
            );
            else return visitor.visitChildren(this);
        }
    ...
    @SuppressWarnings("CheckReturnValue")
    public static class TopUseContext extends TopBindingContext {
        public TerminalNode USE() {
            return getToken(PiescriptAntlrParser.USE, 0);
        }
        ...
        public TerminalNode AS() {
            return getToken(PiescriptAntlrParser.AS, 0);
        }
        ...
        public TopUseContext(TopBindingContext ctx) {
            copyFrom(ctx);
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof PiescriptAntlrParserListener) ((PiescriptAntlrParserListener) listener).enterTopUse(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof PiescriptAntlrParserListener) ((PiescriptAntlrParserListener) listener).exitTopUse(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof PiescriptAntlrParserVisitor) return ((PiescriptAntlrParserVisitor<? extends T>) visitor).visitTopUse(
                this
            );
            else return visitor.visitChildren(this);
        }
    ...
    public final TopBindingContext topBinding() throws RecognitionException {
        ...
        try {
            ...
            switch (_input.LA(1)) {
                case LET:
                    _localctx = new TopLetContext(_localctx);
                    enterOuterAlt(_localctx, 1); {
                    setState(72);
                    match(LET);
                    setState(73);
                    ...
                    break;
                case USE:
                    _localctx = new TopUseContext(_localctx);
    ...
    public static class RepeatExprContext extends ExprContext {
        public TerminalNode REPEAT() {
            return getToken(PiescriptAntlrParser.REPEAT, 0);
        }
        ...
        public RepeatExprContext(ExprContext ctx) {
            copyFrom(ctx);
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof PiescriptAntlrParserListener) ((PiescriptAntlrParserListener) listener).enterRepeatExpr(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof PiescriptAntlrParserListener) ((PiescriptAntlrParserListener) listener).exitRepeatExpr(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof PiescriptAntlrParserVisitor) return ((PiescriptAntlrParserVisitor<? extends T>) visitor).visitRepeatExpr(
                this
            );
            else return visitor.visitChildren(this);
        }
    ...
    public static class LoopExprContext extends ExprContext {
        public TerminalNode LOOP() {
            return getToken(PiescriptAntlrParser.LOOP, 0);
        }
        ...
        public LoopExprContext(ExprContext ctx) {
            copyFrom(ctx);
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof PiescriptAntlrParserListener) ((PiescriptAntlrParserListener) listener).enterLoopExpr(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof PiescriptAntlrParserListener) ((PiescriptAntlrParserListener) listener).exitLoopExpr(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof PiescriptAntlrParserVisitor) return ((PiescriptAntlrParserVisitor<? extends T>) visitor).visitLoopExpr(
                this
            );
            else return visitor.visitChildren(this);
        }
    ...
    public static class MatchExprContext extends ExprContext {
        public TerminalNode MATCH() {
            return getToken(PiescriptAntlrParser.MATCH, 0);
        }
        ...
        public MatchExprContext(ExprContext ctx) {
            copyFrom(ctx);
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof PiescriptAntlrParserListener) ((PiescriptAntlrParserListener) listener).enterMatchExpr(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof PiescriptAntlrParserListener) ((PiescriptAntlrParserListener) listener).exitMatchExpr(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof PiescriptAntlrParserVisitor) return ((PiescriptAntlrParserVisitor<? extends T>) visitor).visitMatchExpr(
                this
            );
            else return visitor.visitChildren(this);
        }
            ...
            switch (_input.LA(1)) {
                ...
                case FN:
                    ...
                    do {
                        ...
                        _errHandler.sync(this);
                        _la = _input.LA(1);
                    } while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 108156759801069568L) != 0));
                    setState(106);
                    match(ARROW);
                    setState(107);
                    expr();
    ...
    public static class AlternativeContext extends ParserRuleContext {
        ...
        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof PiescriptAntlrParserListener) ((PiescriptAntlrParserListener) listener).enterAlternative(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof PiescriptAntlrParserListener) ((PiescriptAntlrParserListener) listener).exitAlternative(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof PiescriptAntlrParserVisitor) return ((PiescriptAntlrParserVisitor<? extends T>) visitor)
                .visitAlternative(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    @SuppressWarnings("CheckReturnValue")
    public static class LitPatternContext extends PatternContext {
        public LiteralContext literal() {
            return getRuleContext(LiteralContext.class, 0);
        }

        public LitPatternContext(PatternContext ctx) {
            copyFrom(ctx);
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof PiescriptAntlrParserListener) ((PiescriptAntlrParserListener) listener).enterLitPattern(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof PiescriptAntlrParserListener) ((PiescriptAntlrParserListener) listener).exitLitPattern(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof PiescriptAntlrParserVisitor) return ((PiescriptAntlrParserVisitor<? extends T>) visitor).visitLitPattern(
                this
            );
            else return visitor.visitChildren(this);
        }
    ...
    @SuppressWarnings("CheckReturnValue")
    public static class EmptyListPatternContext extends PatternContext {
        public TerminalNode LBRACKET() {
            return getToken(PiescriptAntlrParser.LBRACKET, 0);
        }

        public TerminalNode RBRACKET() {
            return getToken(PiescriptAntlrParser.RBRACKET, 0);
        }

        public EmptyListPatternContext(PatternContext ctx) {
            copyFrom(ctx);
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof PiescriptAntlrParserListener) ((PiescriptAntlrParserListener) listener).enterEmptyListPattern(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof PiescriptAntlrParserListener) ((PiescriptAntlrParserListener) listener).exitEmptyListPattern(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof PiescriptAntlrParserVisitor) return ((PiescriptAntlrParserVisitor<? extends T>) visitor)
                .visitEmptyListPattern(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class VarPatternContext extends PatternContext {
        ...
        public VarPatternContext(PatternContext ctx) {
            copyFrom(ctx);
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof PiescriptAntlrParserListener) ((PiescriptAntlrParserListener) listener).enterVarPattern(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof PiescriptAntlrParserListener) ((PiescriptAntlrParserListener) listener).exitVarPattern(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof PiescriptAntlrParserVisitor) return ((PiescriptAntlrParserVisitor<? extends T>) visitor).visitVarPattern(
                this
            );
            else return visitor.visitChildren(this);
        }
    ...
    public static class RecordPatternContext extends PatternContext {
        ...
        public List<RecordPatFieldContext> recordPatField() {
            return getRuleContexts(RecordPatFieldContext.class);
        }

        public RecordPatFieldContext recordPatField(int i) {
            return getRuleContext(RecordPatFieldContext.class, i);
        }
        ...
        public RecordPatternContext(PatternContext ctx) {
            copyFrom(ctx);
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof PiescriptAntlrParserListener) ((PiescriptAntlrParserListener) listener).enterRecordPattern(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof PiescriptAntlrParserListener) ((PiescriptAntlrParserListener) listener).exitRecordPattern(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof PiescriptAntlrParserVisitor) return ((PiescriptAntlrParserVisitor<? extends T>) visitor)
                .visitRecordPattern(this);
            else return visitor.visitChildren(this);
        }
    }

    @SuppressWarnings("CheckReturnValue")
    public static class ExactListPatternContext extends PatternContext {
        public TerminalNode LBRACKET() {
            return getToken(PiescriptAntlrParser.LBRACKET, 0);
        }
        ...
        public ExactListPatternContext(PatternContext ctx) {
            copyFrom(ctx);
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof PiescriptAntlrParserListener) ((PiescriptAntlrParserListener) listener).enterExactListPattern(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof PiescriptAntlrParserListener) ((PiescriptAntlrParserListener) listener).exitExactListPattern(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof PiescriptAntlrParserVisitor) return ((PiescriptAntlrParserVisitor<? extends T>) visitor)
                .visitExactListPattern(this);
            else return visitor.visitChildren(this);
        }
    }

    @SuppressWarnings("CheckReturnValue")
    public static class EmptyRecordPatternContext extends PatternContext {
        public TerminalNode LBRACE() {
            return getToken(PiescriptAntlrParser.LBRACE, 0);
        }
        ...
        public EmptyRecordPatternContext(PatternContext ctx) {
            copyFrom(ctx);
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof PiescriptAntlrParserListener) ((PiescriptAntlrParserListener) listener).enterEmptyRecordPattern(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof PiescriptAntlrParserListener) ((PiescriptAntlrParserListener) listener).exitEmptyRecordPattern(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof PiescriptAntlrParserVisitor) return ((PiescriptAntlrParserVisitor<? extends T>) visitor)
                .visitEmptyRecordPattern(this);
            else return visitor.visitChildren(this);
        }
    }

    @SuppressWarnings("CheckReturnValue")
    public static class ConsListPatternContext extends PatternContext {
        public TerminalNode LBRACKET() {
            return getToken(PiescriptAntlrParser.LBRACKET, 0);
        }
        ...
        public ConsListPatternContext(PatternContext ctx) {
            copyFrom(ctx);
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof PiescriptAntlrParserListener) ((PiescriptAntlrParserListener) listener).enterConsListPattern(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof PiescriptAntlrParserListener) ((PiescriptAntlrParserListener) listener).exitConsListPattern(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof PiescriptAntlrParserVisitor) return ((PiescriptAntlrParserVisitor<? extends T>) visitor)
                .visitConsListPattern(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class WildcardPatternContext extends PatternContext {
        ...
        public WildcardPatternContext(PatternContext ctx) {
            copyFrom(ctx);
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof PiescriptAntlrParserListener) ((PiescriptAntlrParserListener) listener).enterWildcardPattern(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof PiescriptAntlrParserListener) ((PiescriptAntlrParserListener) listener).exitWildcardPattern(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof PiescriptAntlrParserVisitor) return ((PiescriptAntlrParserVisitor<? extends T>) visitor)
                .visitWildcardPattern(this);
            else return visitor.visitChildren(this);
        }
    }
        ...
        try {
            ...
            switch (getInterpreter().adaptivePredict(_input, 13, _ctx)) {
                case 1:
                    ...
                    break;
                case 2:
                    _localctx = new LitPatternContext(_localctx);
                    enterOuterAlt(_localctx, 2); {
                    setState(153);
                    literal();
                }
                ...
                case 3:
                    ...
                    break;
                case 4:
                    _localctx = new EmptyRecordPatternContext(_localctx);
                    enterOuterAlt(_localctx, 4); {
                    setState(155);
                    match(LBRACE);
                    setState(156);
                ...
                case 6:
                    ...
                    break;
                case 7:
                    _localctx = new ExactListPatternContext(_localctx);
                    enterOuterAlt(_localctx, 7); {
                    setState(174);
                    match(LBRACKET);
                    setState(175);
                    ...
                    break;
                case 8:
                    _localctx = new ConsListPatternContext(_localctx);
                    enterOuterAlt(_localctx, 8); {
                    setState(185);
                    match(LBRACKET);
                    setState(186);
    ...
    @SuppressWarnings("CheckReturnValue")
    public static class RecordPatFieldContext extends ParserRuleContext {
        public IdentContext ident() {
            return getRuleContext(IdentContext.class, 0);
        }
        ...
        public RecordPatFieldContext(ParserRuleContext parent, int invokingState) {
            super(parent, invokingState);
        }

        @Override
        public int getRuleIndex() {
            return RULE_recordPatField;
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof PiescriptAntlrParserListener) ((PiescriptAntlrParserListener) listener).enterRecordPatField(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof PiescriptAntlrParserListener) ((PiescriptAntlrParserListener) listener).exitRecordPatField(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof PiescriptAntlrParserVisitor) return ((PiescriptAntlrParserVisitor<? extends T>) visitor)
                .visitRecordPatField(this);
            else return visitor.visitChildren(this);
        }
    }

    public final RecordPatFieldContext recordPatField() throws RecognitionException {
        RecordPatFieldContext _localctx = new RecordPatFieldContext(_ctx, getState());
        enterRule(_localctx, 12, RULE_recordPatField);
        try {
            setState(198);
            _errHandler.sync(this);
    ...
    public final WhenBindingContext whenBinding() throws RecognitionException {
        ...
        enterRule(_localctx, 14, RULE_whenBinding);
        try {
            enterOuterAlt(_localctx, 1);
            {
                setState(200);
    ...
    private PipeExprContext pipeExpr(int _p) throws RecognitionException {
        ...
        int _startState = 16;
        enterRecursionRule(_localctx, 16, RULE_pipeExpr, _p);
        try {
            int _alt;
            enterOuterAlt(_localctx, 1);
            {
    ...
    private AppExprContext appExpr(int _p) throws RecognitionException {
        ...
        int _startState = 32;
        enterRecursionRule(_localctx, 32, RULE_appExpr, _p);
        try {
            int _alt;
            enterOuterAlt(_localctx, 1);
            {
    ...
    public static class TrueLiteralContext extends LiteralContext {
        ...
        public TrueLiteralContext(LiteralContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class DecimalLiteralContext extends LiteralContext {
        ...
        public DecimalLiteralContext(LiteralContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class FalseLiteralContext extends LiteralContext {
        ...
        public FalseLiteralContext(LiteralContext ctx) {
            copyFrom(ctx);
        }
    ...
    @SuppressWarnings("CheckReturnValue")
    public static class EmptyListContext extends PrimaryContext {
        public TerminalNode LBRACKET() {
            return getToken(PiescriptAntlrParser.LBRACKET, 0);
        }
        ...
        public EmptyListContext(PrimaryContext ctx) {
            copyFrom(ctx);
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof PiescriptAntlrParserListener) ((PiescriptAntlrParserListener) listener).enterEmptyList(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof PiescriptAntlrParserListener) ((PiescriptAntlrParserListener) listener).exitEmptyList(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof PiescriptAntlrParserVisitor) return ((PiescriptAntlrParserVisitor<? extends T>) visitor).visitEmptyList(
                this
            );
            else return visitor.visitChildren(this);
        }
    ...
    public static class ListLiteralContext extends PrimaryContext {
        ...
        public ListLiteralContext(PrimaryContext ctx) {
            copyFrom(ctx);
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof PiescriptAntlrParserListener) ((PiescriptAntlrParserListener) listener).enterListLiteral(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof PiescriptAntlrParserListener) ((PiescriptAntlrParserListener) listener).exitListLiteral(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof PiescriptAntlrParserVisitor) return ((PiescriptAntlrParserVisitor<? extends T>) visitor)
                .visitListLiteral(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class LiteralExprContext extends PrimaryContext {
        ...
        public LiteralExprContext(PrimaryContext ctx) {
            copyFrom(ctx);
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof PiescriptAntlrParserListener) ((PiescriptAntlrParserListener) listener).enterLiteralExpr(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof PiescriptAntlrParserListener) ((PiescriptAntlrParserListener) listener).exitLiteralExpr(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof PiescriptAntlrParserVisitor) return ((PiescriptAntlrParserVisitor<? extends T>) visitor)
                .visitLiteralExpr(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public final RecordFieldContext recordField() throws RecognitionException {
        ...
        enterRule(_localctx, 38, RULE_recordField);
        try {
            enterOuterAlt(_localctx, 1);
            {
                setState(386);
    ...
    public final RecordUpdateContext recordUpdate() throws RecognitionException {
        ...
        enterRule(_localctx, 40, RULE_recordUpdate);
        try {
            enterOuterAlt(_localctx, 1);
            {
                setState(390);
    ...
    private TypeAppContext typeApp(int _p) throws RecognitionException {
        ...
        int _startState = 50;
        enterRecursionRule(_localctx, 50, RULE_typeApp, _p);
        try {
            int _alt;
            enterOuterAlt(_localctx, 1);
            {
    ...
    public final TypeAtomContext typeAtom() throws RecognitionException {
        ...
        enterRule(_localctx, 52, RULE_typeAtom);
        try {
            setState(454);
            _errHandler.sync(this);
            switch (_input.LA(1)) {
    ...
    public final RowTypeContext rowType() throws RecognitionException {
        ...
        enterRule(_localctx, 54, RULE_rowType);
        int _la;
        try {
            enterOuterAlt(_localctx, 1);
            {
    ...
    public final RowFieldContext rowField() throws RecognitionException {
        ...
        enterRule(_localctx, 56, RULE_rowField);
        try {
            enterOuterAlt(_localctx, 1);
            {
                setState(468);
    ...
    public static final String _serializedATN = "\u0004\u0001;\u01d9\u0002\u0000\u0007\u0000\u0002\u0001\u0007\u0001\u0002"
        + "\u0002\u0007\u0002\u0002\u0003\u0007\u0003\u0002\u0004\u0007\u0004\u0002"
        + "\u0005\u0007\u0005\u0002\u0006\u0007\u0006\u0002\u0007\u0007\u0007\u0002"
        + "\b\u0007\b\u0002\t\u0007\t\u0002\n\u0007\n\u0002\u000b\u0007\u000b\u0002"
        + "\f\u0007\f\u0002\r\u0007\r\u0002\u000e\u0007\u000e\u0002\u000f\u0007\u000f"
