...
public interface PiescriptAntlrParserVisitor<T> extends ParseTreeVisitor<T> {
     ...
     * @return the visitor result
     */
    T visitMatchExpr(PiescriptAntlrParser.MatchExprContext ctx);
     ...
     * @return the visitor result
     */
    T visitLoopExpr(PiescriptAntlrParser.LoopExprContext ctx);
     ...
     * @return the visitor result
     */
    T visitRepeatExpr(PiescriptAntlrParser.RepeatExprContext ctx);
    ...
    /**
     * Visit a parse tree produced by {@link PiescriptAntlrParser#alternative}.
     * @param ctx the parse tree
     * @return the visitor result
     */
    T visitAlternative(PiescriptAntlrParser.AlternativeContext ctx);
     ...
     * @return the visitor result
     */
    T visitWildcardPattern(PiescriptAntlrParser.WildcardPatternContext ctx);

    /**
     * Visit a parse tree produced by the {@code LitPattern}
     * labeled alternative in {@link PiescriptAntlrParser#pattern}.
     * @param ctx the parse tree
     * @return the visitor result
     */
    T visitLitPattern(PiescriptAntlrParser.LitPatternContext ctx);
     ...
     * @return the visitor result
     */
    T visitVarPattern(PiescriptAntlrParser.VarPatternContext ctx);

    /**
     * Visit a parse tree produced by the {@code EmptyRecordPattern}
     * labeled alternative in {@link PiescriptAntlrParser#pattern}.
     * @param ctx the parse tree
     * @return the visitor result
     */
    T visitEmptyRecordPattern(PiescriptAntlrParser.EmptyRecordPatternContext ctx);
     ...
     * @return the visitor result
     */
    T visitRecordPattern(PiescriptAntlrParser.RecordPatternContext ctx);

    /**
     * Visit a parse tree produced by the {@code EmptyListPattern}
     * labeled alternative in {@link PiescriptAntlrParser#pattern}.
     * @param ctx the parse tree
     * @return the visitor result
     */
    T visitEmptyListPattern(PiescriptAntlrParser.EmptyListPatternContext ctx);

    /**
     * Visit a parse tree produced by the {@code ExactListPattern}
     * labeled alternative in {@link PiescriptAntlrParser#pattern}.
     * @param ctx the parse tree
     * @return the visitor result
     */
    T visitExactListPattern(PiescriptAntlrParser.ExactListPatternContext ctx);

    /**
     * Visit a parse tree produced by the {@code ConsListPattern}
     * labeled alternative in {@link PiescriptAntlrParser#pattern}.
     * @param ctx the parse tree
     * @return the visitor result
     */
    T visitConsListPattern(PiescriptAntlrParser.ConsListPatternContext ctx);

    /**
     * Visit a parse tree produced by {@link PiescriptAntlrParser#recordPatField}.
     * @param ctx the parse tree
     * @return the visitor result
     */
    T visitRecordPatField(PiescriptAntlrParser.RecordPatFieldContext ctx);
     ...
     * @return the visitor result
     */
    T visitLiteralExpr(PiescriptAntlrParser.LiteralExprContext ctx);
