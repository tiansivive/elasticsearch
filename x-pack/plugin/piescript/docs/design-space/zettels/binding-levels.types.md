---
tags: [types, inference, polymorphism, implemented]
refs:
...
**Connections**:
- related: [[value-restriction.types]] — value restriction (D-046) is an additional guard on top of binding levels
- related: standard technique from Odersky/Laufer
