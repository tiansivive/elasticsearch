...
`par { a = expr1, b = expr2 } in body` — independent concurrent bindings. Replaced by spawn + when, which are strictly more expressive (multi-way synchronization, reaction rules, streaming coordination).
