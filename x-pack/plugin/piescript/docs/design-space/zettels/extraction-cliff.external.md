...
- Piescript extends the boundary of what's possible inside ES via the [[data-access-hierarchy.data]]
...
- motivates: [[data-access-hierarchy.data]] — piescript's layered data access is the response to the extraction cliff
